...
export default function ProductDetailPage({ params }) {
    ...
    if (!product) {
        return ( <div className="flex min-h-screen flex-col"><Header /><main className="flex-1 flex items-center justify-center"><div className="text-center"><h1 className="text-2xl font-bold text-white">Sản phẩm không tồn tại</h1><Link href="/" className="mt-4 inline-block text-hineon-blue-light hover:underline">Quay về trang chủ</Link></div></main><Footer /></div> )
    }
