...
const products = [
    { id: 'led-bulb-01', name: 'LED Bulb Aura+', description: 'Ánh sáng quang phổ, điều khiển qua app, tiết kiệm đến 80% điện năng.', imageUrl: 'https://images.unsplash.com/photo-1620050873353-327a33035312?q=80&w=800&auto=format&fit=crop', price: 350000, tag: 'Smart' },
    { id: 'led-strip-02', name: 'LED Dây NeonFlex', description: 'Uốn dẻo linh hoạt, 16 triệu màu, đồng bộ với âm nhạc.', imageUrl: 'https://images.unsplash.com/photo-1597232247968-428a1a3e4b39?q=80&w=800&auto=format&fit=crop', price: 680000, tag: 'RGB' },
    { id: 'led-panel-03', name: 'LED Panel SkyView', description: 'Mô phỏng ánh sáng tự nhiên, giảm mỏi mắt, cho văn phòng hiện đại.', imageUrl: 'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?q=80&w=800&auto=format&fit=crop', price: 1290000, tag: 'Pro' }
];
